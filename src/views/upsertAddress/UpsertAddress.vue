  ...
  <div class="wrapper">
    ...
    <div class="form">
      <div class="form__item">
        ...
        <input class="form__item__content" placeholder="如长沙市" v-model="formData.city" />
      </div>
      <div class="form__item">
        <div class="form__item__label">小区/大厦/学校:</div>
        <input class="form__item__content" placeholder="如中南林业科技大学" v-model="formData.department" />
      </div>
      <div class="form__item">
        <div class="form__item__label">楼号-门牌号:</div>
        <input class="form__item__content" placeholder="青园27栋4层" v-model="formData.houseNumber" />
      </div>
      <div class="form__item">
